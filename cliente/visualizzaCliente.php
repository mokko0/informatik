...
<head>
  ...
  <title>MARKOUNI TECNOTECA - La Scelta Giusta</title>
...
<body>
      ...
      <div class="header_bottom">
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="visualizzaCliente.php">
              <span>
                MARKOUNI TECNOTECA - La Scelta Giusta
              </span>
            </a>
        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              ...
              <p>
                La tecnoteca Markouni è quello che devi scegliere per il meglio, ottieni ciò che desideri in prestito!
              </p>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
          TECNOTECA MARKOUNI NASCE DAL SOGNO DI UN BAMBINO, DARE A TUTTI CIO CHE VOLEVANO IN PRESTITO.
          </p>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            <h2>
              OFFRIAMO SERVIZI PROFESSIONALI FINO A CASA TUA <br>
            </h2>  
          </div>
        </div>
      </div>
  ...
  <section class="service_section layout_padding">
    ...
    <div class="col-sm-6 col-md-4 mx-auto">
        <div class="box" onclick="location.href='cliente.php';" style="cursor: pointer;">
            <div class="img-box">
            ...
            <div class="detail-box">
                ...
                <p>
                Consultazione del catalogo completo delle risorse disponibili
                </p>
            </div>
        </div>
    </div>
...
<div class="col-sm-6 col-md-4 mx-auto">
    <div class="box" onclick="location.href='Sceglicentro.php';" style="cursor: pointer;">
        <div class="img-box">
        ...
        <div class="detail-box">
            ...
            <p>
                Visualizza centri disponibibli in cui prenotare i prodotti
            </p>
        </div>
    </div>
</div>
<div class="col-sm-6 col-md-4 mx-auto">
    <div class="box" onclick="location.href='scegliTipologia.php';" style="cursor: pointer;">
        <div class="img-box">
            <img src="images/s2.png" alt="" />
        </div>
        <div class="detail-box">
            ...
            <p>
                Prenota prodotti SOFTWARE o HARDWARE
            </p>
        </div>
    </div>
</div>
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  OTTIMA, NON VENDONO SOLO ROBE LEGALI!
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                    MI HANNO TRUFFATO, MA SONO SIMPATICI
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  SI SONO STATO TRUFFATO PURE IO, MA HANNO LA MIA FAMIGLIA IN OSTAGGIO
                </p>
              </div>
            </div>
          </div>
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">Template by Markouni</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
