                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        <a class="navbar-brand" href="visualizzaCliente.php">
                            <span>
                                TECNOTECA MARKOUNI - LA SCELTA GIUSTA
                            </span>
                        </a>
    ...
    <section class="service_section layout_padding">
        <div class="container ">
            <div class="heading_container heading_center">
                <h2> Scegli la tipologia da visualizzare:</h2>
            </div>
            <?php
            while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
                ...
                echo '<div class="col-sm-6 col-md-4 mx-auto">
                    ...
                    <div class="detail-box">
                        <h5>' . $stringa . '</h5>
                        <input type="button" value="Visualizza" onclick="location.href=\'cliente.php?idCategoria=' . $idCategoria . '\'">
                    </div>
                    </div>
                </div>';
            }
